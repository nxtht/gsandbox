...
void AGeometryHubActor::DoActorSpawn1()
{
    ...
    if (World)
    {
        ...
        {
            const FTransform GeometryTransform = FTransform(FRotator::ZeroRotator, FVector(0.0f, 300.0f, 300.0f));
...
void AGeometryHubActor::OnTimerFinished(AActor* Actor)
{
    if (Actor)
    {
        ...
        UE_LOG(LogGeometryHub, Display, TEXT("Cast is successful, amplitude: %f"), Geometry->GetGeometryData().Amplitude);
